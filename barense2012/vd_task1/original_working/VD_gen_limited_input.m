function [inp_matrix] = VD_gen_limited_input(nInputDims, p)
...
avail_features = permn(p.features, p.numInputDims_Caudal);
...
for seg = 1:nInputDims / p.numInputDims_Caudal
...
% defined in segment.
inp_matrix_temp = ones(p.numRows,p.numRows,nInputDims);
