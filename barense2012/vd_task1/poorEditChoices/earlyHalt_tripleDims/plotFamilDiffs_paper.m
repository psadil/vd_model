function [] = plotFamilDiffs_paper(firstRat, lastRat, folderName)
...
errorbar([.75,1.25 ; 1.75, 2.25],[dPrime_first_adj_all_mean(4), dPrime_second_adj_all_mean(4) ; dPrime_first_adj_all_mean(3), dPrime_second_adj_all_mean(3)], [1,1 ; 1,1])
